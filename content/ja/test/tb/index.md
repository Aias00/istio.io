---
title: テキストブロック
description: 基本的なテキストブロック。
skip_sitemap: true
---

HTML タグ付きの通常のテキストブロック
...
yaml 出力とダウンロード名付きの Bash テキストブロック
...
json 出力とダウンロード名付きの Bash テキストブロック
